var requestUrl =
  "https://api.rawg.io/api/platforms?key=ac7de14847e84d37be3b60940720db8c";
var gamesUrl =
  "https://api.rawg.io/api/games?key=ac7de14847e84d37be3b60940720db8c&dates=2019-09-01,2019-09-30&platforms=1";
var testUrl =
  "https://api.rawg.io/api/games?key=ac7de14847e84d37be3b60940720db8c&parent_platforms=" +
  choice1 +
  "&genres=" +
  choice2;
...
var testUrl =
  ("https://api.rawg.io/api/games?metacritic=80,100&key=ac7de14847e84d37be3b60940720db8c",
  " https://api.rawg.io/api/games?parent_platforms=2&ordering=-metacritic&key=ac7de14847e84d37be3b60940720db8c");
var url2 =
  "https://api.rawg.io/api/genres?key=ac7de14847e84d37be3b60940720db8c&results=30";
var url3 =
  "https://api.rawg.io/api/platforms/lists/parents?key=ac7de14847e84d37be3b60940720db8c";
var url4 =
  "https://api.rawg.io/api/tags?ordering=name&key=ac7de14847e84d37be3b60940720db8c";
var devUrl =
  "https://api.rawg.io/api/games/key=ac7de14847e84d37be3b60940720db8c&page=5";
var test2Url =
  "https://api.rawg.io/api/games?search=Cyberpunk 2077&key=ac7de14847e84d37be3b60940720db8c";
...
const questions = [
  ...
  {
    question:
      "Good choice! Now are we going solo or looking to play with your friend(s)",
    options: ["Solo", "Friends"],
  },
  {
    question: "What genre are you in the mood for today/tonight?",
    options: ["Action", "Adventure", "Shooter", "RPG", "Indie"],
  },
];
...
function showResults() {
  ...
  var finalUrl =
    "https://api.rawg.io/api/games?page_size=40&parent_platforms=" +
    chosenConsole +
    "&tags=" +
    chosenWayToPlay +
    "&genres=" +
    chosenGenre +
    "&key=ac7de14847e84d37be3b60940720db8c";
    ...
    .then(function (data) {
      ...
      for (let i = 1; i <= 6; i++) {
        ...
        if (gameImageEl && gameTitleEl) {
          gameImageEl.setAttribute(
            "src",
            data?.results?.[randomEl]?.background_image
          );
          gameTitleEl.textContent = data?.results?.[randomEl]?.name;
          releasedEl.textContent =
            "Released: " + data?.results?.[randomEl]?.released;
          esrbEl.textContent =
            "ESRB: " + data?.results?.[randomEl]?.esrb_rating?.name;
          metacriticEl.textContent =
